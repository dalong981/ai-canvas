...
> 版本: v0.0.6
> 更新: 2026-02-01 - Canvas → Logseq 单向同步
...
| v0.0.3 | 2026-02-01 | 添加右侧 AI 对话面板 UI |
| v0.0.4 | 2026-02-01 | 本地保存/加载功能，移除对话面板 |
| v0.0.5 | 2026-02-01 | 本地文件保存到 data/ 目录，支持画布列表选择 |
| v0.0.6 | 2026-02-01 | Canvas → Logseq 单向同步，双区分离 |
